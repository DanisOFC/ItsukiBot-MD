...
console.log(chalk.bold.cyanBright(`☁ ARCHIVOS NO ESENCIALES ELIMINADOS`))
}} catch (err){
console.log(chalk.bold.red(`☁ OCURRIÓ UN ERROR`))
}}
...
console.log(chalk.bold.red(`☁ NO SE LOGRÓ BORRAR`))
} }) }) }) })
}
...
setInterval(async () => {
await purgeSession()
console.log(chalk.bold.cyanBright(`☁ SESIONES NO ESENCIALES ELIMINADAS`))}, 1000 * 60 * 30)
...
setInterval(async () => {
await purgeOldFiles()
console.log(chalk.bold.cyanBright(`☁ ARCHIVOS RESIDUALES ELIMINADAS`))}, 1000 * 60 * 30)
_quickTest()
